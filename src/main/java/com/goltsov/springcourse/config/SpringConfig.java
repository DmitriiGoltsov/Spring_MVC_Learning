...
@EnableJpaRepositories("com.goltsov.springcourse.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    /* Вместо JDBC template теперь будет использоваться Hibernate
   ...
   /* @Bean
   используется в хайбернейте. Для спринг дата ДжиПиЭй используется энтитимэнаджерфактори.

    public LocalSessionFactoryBean sessionFactory() {
        LocalSessionFactoryBean sessionFactory = new LocalSessionFactoryBean();
        sessionFactory.setDataSource(getDataSource());
        sessionFactory.setPackagesToScan("com.goltsov.springcourse.models");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.goltsov.springcourse.models");
